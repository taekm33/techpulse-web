---
title: "OpenAI Launches Robotics Division: Physical AI Is Now a Priority"
summary: "Sam Altman officially announced OpenAI Robotics on May 31, 2026. Built on the $2.9B Figure AI acquisition, it targets skilled-worker augmentation and eventually personal robots."
category: "ai-news"
date: "2026-06-01"
readingTime: 6
tags: ["OpenAI", "robotics", "humanoidrobots", "physicalAI", "SamAltman"]
---

<div class="article-tldr">
**TL;DR** — Sam Altman posted on X on May 31, 2026, officially declaring OpenAI Robotics a new strategic division. Built on the recently closed $2.9B acquisition of Figure AI, the division is led by Aditya Ramesh and is actively hiring across hardware, systems, operations, and ML engineering. The near-term focus: robots that augment skilled workers building infrastructure. The long-term vision: a personal robot for everyone.
</div>
...
| Metric | Value |
|--------|-------|
| Figure AI acquisition price | **$2.9 billion** |
| Current Figure deployments | BMW SC factory, Amazon warehouses |
| Robotics division leader | **Aditya Ramesh** (led DALL-E) |
| Near-term focus | Skilled trades, infrastructure construction |
| Long-term vision | Personal robot for every individual |
| Robotics API beta (expected) | **Q3 2026** |
| Global humanoid robot investment (2024–2026) | **$5B+** |
| OpenAI minority stakes in robotics | Figure AI, 1X |
</div>
...
**The Aditya Ramesh connection**: Ramesh led the DALL-E image generation program at OpenAI — the same research that is now described as having "evolved into" the robotics program. The thread from text-to-image to world simulation to physical robot control is now the explicit origin story OpenAI is telling about this division.
</div>
...
**OpenAI's software-first advantage**: Where most competitors have hardware as their core asset, OpenAI is positioning the Robotics API as the differentiating layer. If the API allows any developer to program physical robot tasks in natural language, OpenAI may replicate the ecosystem flywheel that made ChatGPT the default AI interface — this time for physical AI.
</div>
...
**What we don't know yet**: There is no product timeline, no named construction or infrastructure partner, and no disclosed hardware roadmap for the new division. OpenAI's current physical robotics exposure is minority stakes in Figure (now fully acquired), 1X, and Physical Intelligence. How OpenAI's existing agent and Operator infrastructure maps onto a robotics software control stack remains unspecified.
</div>
...
1. **OpenAI Robotics officially launched** — May 31 announcement, led by Aditya Ramesh (DALL-E), hiring across all hardware and ML engineering disciplines
2. **Built on Figure AI** — $2.9B acquisition complete; Figure's bipedal robots are actively deployed at BMW and Amazon
3. **Robotics API coming** — Natural language robot programming, Q3 2026 beta; the ChatGPT API moment for physical AI
4. **Near-term focus is augmentation** — Skilled trades and infrastructure construction, framed as worker support not replacement
