---
title: "Apple WWDC26 Opens Today: iOS 27, CoreAI, and a Multi-Provider Siri"
summary: "Apple kicks off WWDC26 on June 8 with iOS 27 as the centerpiece, featuring CoreAI — a new framework that lets third-party AI models integrate directly with Siri and system apps — alongside a sweeping Apple Intelligence expansion."
category: "ai-news"
date: "2026-06-08"
readingTime: 5
...
<span class="stat-label">New WWDC26 video sessions</span>
</div>
<div class="stat-item">
<span class="stat-number">1,000+</span>
<span class="stat-label">Developers at Apple Park in person</span>
</div>
<div class="stat-item">
<span class="stat-number">3</span>
<span class="stat-label">Third-party AI models tested with Siri</span>
</div>
</div>
...
<strong>For developers:</strong> The CoreAI framework is the one to watch closely. Once the API details are published after the keynote, third-party apps will have a path to surface their AI capabilities through Siri — a distribution channel that reaches billions of devices. Check the WWDC26 session catalog for implementation specifics.
</div>

<div class="article-callout info">
<strong>What's not coming yet:</strong> Health AI features from Apple's internal "Mulberry" project — including blood sugar monitoring and camera-based workout tracking — are not expected in the initial iOS 27 release. Apple may announce them separately after WWDC26.
</div>
...
<h3>Key Takeaways</h3>
<ul>
<li>WWDC26 keynote begins June 8 at 10 a.m. PT; iOS 27 is the anchor announcement.</li>
<li>CoreAI lets developers integrate Claude, Gemini, and other third-party AI models with Siri and iOS system apps.</li>
<li>Visual Intelligence moves to the Camera app for broader exposure and gains nutrition label and business card reading.</li>
<li>A five-tool AI photo editing suite (Extend, Reframe, Enhance, rebuilt Clean Up, and natural language editing) is expected.</li>
<li>Health AI features remain on hold; expect a separate announcement after the conference.</li>
</ul>
</div>
