---
title: "Samsung Electronics Rolls Out ChatGPT and Codex Company-Wide in One of OpenAI's Largest Enterprise Deployments Ever"
summary: "Samsung Electronics is giving ChatGPT Enterprise and Codex to all employees in Korea and its global Device eXperience division, expanding a relationship that began with memory chip supply into company-wide AI adoption."
category: "ai-news"
date: "2026-06-22"
readingTime: 5
tags: ["Samsung Electronics", "OpenAI", "ChatGPT Enterprise", "Codex", "Enterprise AI"]
---

<div class="article-tldr">
Samsung Electronics announced on June 21 that it will deploy ChatGPT Enterprise and the Codex coding agent to all employees in Korea and to every employee worldwide in its Device eXperience (DX) division. OpenAI called it "one of the largest enterprise deployments to date," covering use cases from R&D and manufacturing to marketing and corporate functions — a sign that AI adoption inside major manufacturers is moving from pilot projects to full organizational rollout.
</div>
...
<strong>All employees</strong> in Korea get access to ChatGPT Enterprise and Codex<br/>
<strong>Global DX division</strong> employees worldwide also included<br/>
<strong>16+</strong> other Korean companies already using ChatGPT Enterprise or Codex (LG Electronics, Toss, Krafton, and more)
</div>
...
Enterprise IT leaders evaluating similar rollouts should pay attention to how Samsung is pairing tool access with governance: company-wide deployments need clear data-handling policies and training programs that go well beyond what's needed for a single-department pilot.
</div>

<div class="article-callout info">
Samsung was already a key supplier of memory chips powering OpenAI's AI infrastructure. This deployment turns that supplier relationship into a platform-customer relationship as well, illustrating how semiconductor and AI services partnerships are increasingly intertwined.
</div>
...
<ul>
<li>Samsung Electronics deploys ChatGPT Enterprise and Codex to all Korea employees and global DX division staff</li>
<li>OpenAI calls it one of its largest enterprise deployments ever</li>
<li>Relationship expands from memory chip supply to company-wide AI adoption</li>
