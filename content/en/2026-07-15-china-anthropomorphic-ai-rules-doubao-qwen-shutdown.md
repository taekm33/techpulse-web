---
title: "China's Anthropomorphic AI Law Takes Effect Today: Doubao and Qwen Pull the Plug on Human-Like Agents"
summary: "China's Interim Measures for Anthropomorphic AI Interaction Services came into force on July 15, 2026. ByteDance's Doubao and Alibaba's Qwen have shut down humanlike AI agent features for millions of users, with conversation data set for permanent deletion after October 15. It is the world's first law to legally define and restrict the 'humanlike' interaction style of AI agents."
category: "ai-news"
date: "2026-07-15"
readingTime: 5
tags: ["China", "AI Regulation", "Doubao", "Qwen", "ByteDance", "Alibaba", "AI Agents"]
---

<div class="article-tldr">
<strong>TL;DR</strong> — China's <strong>Interim Measures for the Administration of Artificial Intelligence Anthropomorphic Interaction Services</strong> went into effect <strong>today, July 15, 2026</strong>. The rules ban AI services that simulate human personality through sustained emotional interaction. ByteDance's <strong>Doubao</strong> has taken its custom agent feature offline, and Alibaba's <strong>Qwen</strong> has disabled all humanlike and user-created agent functions. User conversation histories face <strong>permanent, unrecoverable deletion after October 15</strong>. This is the world's first legislation to directly target the <em>style</em> of how AI interacts with humans — not just its outputs.
</div>
...
<strong>Effective Date</strong> July 15, 2026<br/>
<strong>Issuing Authorities</strong> 5 government bodies (CAC, NDRC, MIIT, MPS, SAMR)<br/>
<strong>Doubao Agent Shutdown</strong> July 15, 2026<br/>
<strong>Qwen Agent Shutdown</strong> July 10–15, 2026 (phased)<br/>
<strong>User Data Deletion Deadline</strong> After October 15, 2026 (permanent)<br/>
<strong>Strictest Restrictions</strong> AI companions targeting minors
</div>
...
This regulation is one of the world's first to legally define what makes an AI "humanlike" and restrict it at the interaction-design level. Where the EU AI Act uses a risk-tier system based on deployment context, China's approach targets the <strong>interaction modality itself</strong> — regardless of the use case. That is a meaningfully different regulatory philosophy, and one that could influence how other governments frame future AI companion rules.
</div>
...
**For global AI product teams:** China's law is the first to formally define and prohibit "anthropomorphic interaction" as a design pattern. Even if your product doesn't operate in China, it's worth asking: if you had to draw the line between "AI as useful tool" and "AI as simulated person," where does your product currently sit — and where do you want it to sit? That line is now legally defined in the world's largest AI consumer market.
</div>
...
<ul>
<li>China's Anthropomorphic AI Interaction Services rules took effect July 15, 2026 — the world's first law targeting AI's humanlike interaction style directly</li>
<li>ByteDance Doubao and Alibaba Qwen shut down custom and humanlike agent features for millions of users effective today</li>
<li>User conversation data faces permanent, unrecoverable deletion after October 15, 2026 — no migration path offered</li>
<li>Core prohibition: AI simulating human personality through sustained emotional interaction; strictest limits on minor-facing virtual companions</li>
