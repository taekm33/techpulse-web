---
title: "AI가 87년 묵은 수학 난제 '야코비안 추측' 반례 발견…수학계 충격"
summary: "하버드 수학자 레벤트 알포게가 앤트로픽의 Claude Fable 5의 도움으로 1939년부터 미해결이었던 야코비안 추측이 거짓임을 단 216자 반례로 증명해 세계 수학계를 놀라게 했다."
category: "ai-news"
date: "2026-07-21"
readingTime: 5
tags: ["AI수학", "야코비안추측", "Claude", "앤트로픽", "수학난제"]
---

<div class="article-tldr">
<strong>TL;DR:</strong> 하버드대 수학자 레벤트 알포게가 앤트로픽 AI 'Claude Fable 5'의 도움을 받아 1939년 제기된 야코비안 추측(Jacobian conjecture)의 반례를 발견했다. 216자짜리 반례 하나로 87년간 미해결 상태였던 이 난제가 '거짓'임이 밝혀졌으며, 수학계 전문가들은 이를 AI가 수학 분야에서 이룬 가장 큰 성과라고 평가하고 있다.
</div>
...
<div class="article-stats">
  <div class="stat-item">
    <span class="stat-number">87년</span>
    <span class="stat-label">야코비안 추측의 미해결 기간</span>
  </div>
  <div class="stat-item">
    <span class="stat-number">216자</span>
    <span class="stat-label">반례의 길이 (단 한 문장)</span>
  </div>
  <div class="stat-item">
    <span class="stat-number">18개</span>
    <span class="stat-label">스메일의 21세기 수학 난제 목록 수</span>
  </div>
</div>
...
<ul>
  <li>📅 <strong>발표일:</strong> 2026년 7월 19일 (X/트위터)</li>
  <li>👨‍🔬 <strong>발견자:</strong> 하버드대 수학자 레벤트 알포게</li>
  <li>🤖 <strong>AI 기여:</strong> 앤트로픽 Claude Fable 5 ("Fable")</li>
  <li>📐 <strong>문제:</strong> 1939년 제기된 야코비안 추측 (87년 미해결)</li>
  <li>📏 <strong>반례 크기:</strong> 216자 (단 한 문장)</li>
  <li>🔓 <strong>남은 문제:</strong> 변수 2개(n=2) 경우는 여전히 미해결</li>
</ul>
</div>
